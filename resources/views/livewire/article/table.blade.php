<div>
    <div class="flex flex-wrap items-center justify-between w-full border-b-2 border-t-2 border-gray-200 p-4 bg-white ">
        <div>
    ...
    <div>
            ...
            <div class="border-b-2 border-t-2 border-gray-200 p-4 flex justify-between group bg-white">
                ...
                <div class="flex flex-wrap items-center justify-between w-full">
                    ...
                    <div class="w-full md:w-4/12 mb-2">
                        ...
                        <a href="#"
                            class="inline-block text-gray-500 border-2 border-gray-300 px-3 py-1 rounded-lg mr-2 mb-2 bg-white">
                            {{-- {{ $category->name }} --}}
                            আন্তর্জাতিক,
                        </a>
                        {{-- @endforeach --}}
        ...
        <div class="bg-white p-4 flex items-center justify-between border-t border-gray-200 sm:px-6">
