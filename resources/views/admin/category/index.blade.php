<x-app-layout>
    <main class="flex-1 overflow-y-auto">
        <div class="pt-8 w-full mx-auto px-4 sm:px-6 lg:px-8">
            <x-header.breadcrumb title="category"></x-header.breadcrumb>
                        ...
                        <div class="w-full flex items-center justify-between p-6 space-x-6">
                            <div class="flex-1 truncate">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <span
                                        class="flex-shrink-0 inline-block px-2 py-0.5 text-green-800 text-xs font-medium bg-green-100 rounded-full">Rakibul
                                        Islam</span>
                                </div>
